...
async function beginBirthdaySequence(opts = {}){
  if(opts.instant){
    // We already played the cinematic 3·2·1 blast-off + flash — go straight
    // into the gallery with a burst of effects instead of a separate
...
async function runEffortsSequence(){
  ...
  const seq = [
    ...
    'Every lesson.',
    { text: 'ALL OF IT — WORTH IT.', cls:'strong' }
  ];
